...
class StockInDetail extends Model
{
    ...
    protected $primaryKey = 'stock_in_detail_id';
    ...
    {
        return $this->belongsTo(OverAllBill::class, 'bill_id', 'id');
    }

    public function waste(): BelongsTo
    {
        return $this->belongsTo(WastageDetails::class, 'waste_id', 'waste_id');
    }
    ...
    public function stockOutParent(): BelongsTo
    {
