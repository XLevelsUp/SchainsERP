...
class GoldToCashResource extends JsonResource
{
    public function toArray($request): array
    {
        return [
            ...
            // These are stored swapped in DB (total_gold→purity, total_grams→total_grams)
            // Return them with frontend-friendly names
            'total_gold'      => (float) $this->purity,        // pure gold weight
            'total_grams'     => (float) $this->total_grams,   // touch-adjusted
            ...
            // All payment sources — CASH_ON_HAND and/or BANK rows
