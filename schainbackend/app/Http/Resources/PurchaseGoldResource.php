...
class PurchaseGoldResource extends JsonResource
{
    public function toArray($request): array
    {
        return [
            ...
            'taken_total_cash' => (float) $this->taken_total_cash,
            'taken_total_grams' => (float) $this->taken_total_grams,
            'taken_purity'    => (float) $this->taken_purity,
