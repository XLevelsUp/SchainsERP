...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('stock_details', function (Blueprint $table) {
            ...
            // Indexes
            $table->index(['is_hided', 'is_freezed', 'is_completed'], 'idx_main');
            $table->index(['entry_type', 'stock_type'], 'idx_entry');
            $table->index(['given_to', 'given_by'], 'idx_user');
            $table->index(['retailer_id', 'to_retailer_id'], 'idx_retailer');
