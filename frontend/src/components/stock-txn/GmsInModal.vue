...
import type { GmsInFormValues, GmsInItemInput, Item, UserDetailListItem } from '@/types'

/*
|--------------------------------------------------------------------------
| GMS In modal — ported from the former GmsInView.vue. Unlike GMS Out,
| both given_by and given_to are required here.
|--------------------------------------------------------------------------
*/
...
<template>
  <BaseModal title="GMS In" badge="IN" badge-class="bg-emerald-600" max-width="max-w-4xl" @close="emit('close')">
    <p
      v-if="formError"
