...
import type { Item, StockInFormValues, StockInItemInput, UserDetailListItem } from '@/types'

/*
|--------------------------------------------------------------------------
| Stock In modal — ported from the former StockInView.vue. Validation,
| payload shape, and calculations are unchanged.
|--------------------------------------------------------------------------
*/
...
<template>
  <BaseModal title="Stock In" badge="IN" badge-class="bg-emerald-600" max-width="max-w-4xl" @close="emit('close')">
    <p
      v-if="formError"
    ...
    <form class="flex flex-col gap-6" @submit.prevent="handleSubmit">
      ...
      <div class="flex items-center justify-end gap-3 border-t border-slate-200 pt-4">
        ...
        <BaseButton type="submit" :disabled="isSaving">{{ isSaving ? 'Recording…' : 'Record stock in' }}</BaseButton>
      </div>
    </form>
  </BaseModal>
</template>
